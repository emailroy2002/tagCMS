...
<div id="form" style="line-height:20px; text-align:left; padding:30px">
    ...
    <form id="edit_file" name="edit_file">
        ...
        <textarea name="form_description" id="form_description" class="tinyMCE"  placeholder="Enter Description" style="border:1px solid #ccc; width:30%"><?php echo $description?></textarea>
