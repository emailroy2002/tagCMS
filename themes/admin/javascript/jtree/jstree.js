 ...
 */
	...
	var instance_counter = 0,
		...
		_d = document, _node = _d.createElement('LI'), _temp1, _temp2, _temp3, _temp4, _temp5, _temp6;
	...
	_temp1.className = 'jstree-anchor jstree-anchor-node';
    ...
    _temp3.className = 'jstree-icon jstree-themeicon file-c jstree-themeicon-custom items-hover-icons items-float-right items-margin-right';

	_temp4 = _d.createElement('A');
	_temp4.className = 'jstree-anchor jstree-create';
	_temp4.setAttribute('href','#');
    
    
    _temp5 = _d.createElement('I');
    _temp5.className = 'jstree-icon jstree-themeicon file jstree-themeicon-custom items-hover-icons items-float-right';
        
	_temp6 = _d.createElement('A');
	_temp6.className = 'jstree-anchor file-create';
	_temp6.setAttribute('href','#');
